            ...
            <div className="bg-gradient-to-br from-[#f97316]/10 to-[#fb923c]/10 rounded-2xl p-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">전문 의료진</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">최신 시설</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      첨단 의료 장비와 쾌적한 진료 환경
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-2">환자 중심</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      맞춤형 치료와 세심한 케어 서비스
                    </p>
                  </div>
        ...
        <section className="bg-gray-50 dark:bg-[#1a1a1a] py-16">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-[#2c2c2c] p-8 rounded-xl shadow-sm">
