                            ...
                            <thead>
                              <tr className="bg-gray-50">
                                {sortedSchedules.map((schedule) => (
                                  <th key={schedule.id} className="py-2 px-3 text-center font-semibold text-gray-700 border border-gray-200">
                            ...
                            <tbody>
                              <tr>
                                {sortedSchedules.map((schedule) => {
                                  ...
                                  return (
                                    <td key={schedule.id} className="py-3 px-3 text-center border border-gray-200">
