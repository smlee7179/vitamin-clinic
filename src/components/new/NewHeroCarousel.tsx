      ...
      <section className="w-full relative">
        ...
        <div className="absolute inset-0 flex flex-col gap-6 items-center justify-center p-6 md:p-12">
          <div className="flex flex-col gap-3 text-center max-w-3xl">
            ...
            <Link
              href="/contact"
              className="hidden md:inline-flex mt-3 min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-10 px-4 md:h-12 md:px-5 bg-[#f97316] text-white text-sm md:text-base font-bold leading-normal tracking-[0.015em] hover:bg-[#ea580c] transition-colors shadow-lg"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span className="truncate">오시는길</span>
            </Link>
            {/* Mobile: 전화하기 Button */}
            <a
              href={`tel:${phoneNumber.replace(/[\s-]/g, '')}`}
              className="md:hidden mt-3 inline-flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-10 px-4 md:h-12 md:px-5 bg-[#f97316] text-white text-sm md:text-base font-bold leading-normal tracking-[0.015em] hover:bg-[#ea580c] transition-colors shadow-lg"
            >
