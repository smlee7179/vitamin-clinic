  ...
  return (
    <section className="relative w-full h-[320px] sm:h-[400px] md:h-[520px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full h-full text-center px-4">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white drop-shadow-lg mb-4 leading-tight">따뜻한 마음으로 치료하는<br />비타민 의원</h1>
        <p className="text-base sm:text-lg md:text-xl text-white/90 font-medium mb-8 drop-shadow">60년간 부산 지역 어르신들의 건강을 지키는 정형외과 전문의원</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-lg mx-auto">
          <a href="tel:051-123-4567" className="bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white font-semibold text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 ease-out backdrop-blur-sm border border-white/20">📞 전화걸기</a>
          <Link href="/contact" className="border-2 border-white text-white hover:bg-white hover:text-primary-600 font-semibold text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 rounded-2xl transition-all duration-300 ease-out hover:shadow-lg hover:-translate-y-1">오시는 길</Link>
        </div>
      </div>
